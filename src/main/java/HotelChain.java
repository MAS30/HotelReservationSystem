public class HotelChain {
    ...
    public void checkInGuest(Room room, Guest guest) {
        ...
        room.checkIn(guest);
        System.out.println("Guest Named " + guest.getName() + " checked in to room " + room.getNumber());
    }
    ...
    public void checkOutGuest(Room room, Guest guest) {
        ...
        room.checkOut();
        System.out.println("Guest Named " + guest.getName() + " checked out from room " + room.getNumber());
    }
}
